    ...
    <aside className="w-72 bg-brand-surface border-r border-slate-800 flex flex-col justify-between h-full text-slate-300">
      <div className="p-6">
        ...
        <nav className="space-y-1 mb-8">
          <button onClick={() => setView('config')} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium hover:bg-slate-800 hover:text-white transition">
            <span>➕ Añadir Plataforma</span>
          </button>
          <button onClick={() => setView('appearance')} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium hover:bg-slate-800 hover:text-white transition">
            <span>🎨 Personalizar Panel</span>
          </button>
          <button onClick={() => setView('instructions')} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium hover:bg-slate-800 hover:text-white transition">
